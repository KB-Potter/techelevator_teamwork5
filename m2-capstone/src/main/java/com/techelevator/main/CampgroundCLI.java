...
public class CampgroundCLI {
    ...
    private void handleViewCampgrounds(Park park, List<Campground> campgroundList) {
        formattedDisplay.displayCampgrounds(park, campgroundList);
    ...
    private void handleMakingReservation(Campground campgroundChoice, LocalDate arrivalDate, LocalDate departureDate) {
        ...
        List<Site> sitesInCampground = siteDAO.getAvailableSites(campgroundChoice, arrivalDate, departureDate);

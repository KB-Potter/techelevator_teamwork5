...
SELECT * from employee WHERE first_name = 'Fredrick' AND last_name = 'Keppard';
SELECT first_name, last_name, birth_date from employee;
SELECT department_id, first_name, last_name, birth_date, gender, hire_date FROM employee WHERE first_name = 'Fredrick' AND last_name = 'Keppard';
...
BEGIN TRANSACTION;
SELECT department_id, employee.employee_id, first_name, last_name, birth_date, gender, hire_date 
FROM employee  
FULL OUTER JOIN project_employee ON project_employee.employee_id = employee.employee_id  
FULL OUTER JOIN project ON project.project_id = project_employee.project_id  
